...
const SignUp = ({addUser}) => {
    ...
    let [lastName, setLastNameState] = useState(undefined);
    let [firstName, setFirstNameState] = useState(undefined);
    let [email, setEmailState] = useState(undefined);
    let [password, setPasswordState] = useState(undefined);
