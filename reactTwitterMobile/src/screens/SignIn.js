...
import {Avatar, Card, Input, Text} from "react-native-elements";
...
const SignIn = ({navigation, users, setCurrentUser, currentUser}) => {
    ...
    return (
        <SafeAreaView>
            <Card>
                <View style={styles.container}><Avatar avatarStyle={styles.title} source={{uri: IMG}}>
                </Avatar>
                    <Text h4>
                        Twitter
                    </Text>
